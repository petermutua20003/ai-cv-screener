...
1. Clone the repository:
   git clone https://github.com/petermutua20003/ai-cv-screener.git
...
2. Upload a plain text (.txt) file containing the job description.
3. Select one or more PDF resumes to upload.
4. Click Rank Candidates to view the parsed profiles, matched/missing skills, and overall match scores.
